...
<head>
     ...
     <title>Halaman Registrasi|Kae Squad</title>
</head>

<body background="img/webb-dark.png">

     <div class="container">
          <div class="row my-5">
               <div class="col-md-6 text-center login bg-success">
                    <h4 class="fw-bold" style="color: white;">REGISTRASI</h4>
                    <form action="" method="post">
                         ...
                         <button class="btn btn-primary btn-sm text-uppercase text-light" style="font-weight: 600;"
                              type="submit" name="register">REGISTER</button>|
                         <a href="login.php" class="btn btn-danger btn-sm text-light" style="font-weight: 600;"><i
